...
// the provider. When the provider implements [RefreshingProvider] and the base
// response is a 401/403, Transport refreshes the credential and retries once
// (provided the request body can be replayed).
